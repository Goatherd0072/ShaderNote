Shader "Chapter6/HalfLambert"
{
    Properties
    {
        [MainTexture] _MainTex ("Texture", 2D) = "white" {}
        _Diffuse ("Diffuse", Color) = (1,1,1,1)
        _HalfLambertA("HalfLambertA", Range(0,1)) = 0.5
        _HalfLambertB("HalfLambertB", Range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float HalfLambert = dot(i.normalWS, lightDir)*_HalfLambertA + _HalfLambertB;
                float3 diffuse =  lightCol*_Diffuse.xyz*HalfLambert;
